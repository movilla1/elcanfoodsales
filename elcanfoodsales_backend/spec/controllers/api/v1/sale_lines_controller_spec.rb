...
RSpec.describe Api::V1::Sales::SaleLinesController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new sale_line" do
        ...
        expect(response.location).to eq(sale_line_url(SaleLine.last))
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested sale_line" do
        sale_line = SaleLine.create! valid_attributes
        put :update, params: {id: sale_line.to_param, sale_line: new_attributes}, session: valid_session
        sale_line.reload
